...
%>
<jsp:forward page="/assetsEditList">
						...
						<div class="nav-search" id="nav-search">
							...
							<%--</form>--%>
								<form class="form-search" action = "/showMenus" method = "post">
									...
									&nbsp;|&nbsp;
									<%--<input type = "button" value = "添加资产" onclick="window.location.href='/addMenu'" class="btn btn-xs">--%>
									<%--&nbsp;|&nbsp;--%>
									<%--<input type = "button" value = "资产分类" onclick="window.location.href='/showCategories'" class="btn btn-xs">--%>
									<%--&nbsp;|&nbsp;--%>
					...
					<table border="1" cellspacing="0" cellpadding="5" class="table table-striped table-bordered table-hover">
						...
						<c:forEach items="${menus}" var="menu">
							<tr>
								...
								<td align="center">${menu.assetcoding}</td>
								...
								<td align="center">${menu.mtype}</td>
								<td align="center">${menu.beginusedate}</td>
								<td align="center">${menu.orivalue}</td>
								<td align="center">${menu.depreciation}</td>
								<td align="center">${menu.netvalue}</td>
								<td align="center">${menu.person}</td>
								<td>
									<input type = "button" value = "删除" onclick="javascript:if(confirm('确认删除${menu.mname}'))window.location.href='/assetsDelete/${menu.mid}'">
									<input type = "button" value = "更新" onclick="window.location.href='/assetsEdit/${menu.mid}'">
								</td>
							</tr>
						</c:forEach>
					</table>
