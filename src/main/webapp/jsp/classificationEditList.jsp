					...
					<table border="1" cellspacing="0" cellpadding="5" class="table table-striped table-bordered table-hover">
						...
						<c:forEach items="${categories}" var="category">
							<tr>
								...
								<td>
									<input type = "button" value = "删除" onclick="javascript:if(confirm('确认删除${category.cname}?'))window.location.href='/classificationDelete/${category.cid}'">
									<input type = "button" value = "更新" onclick="window.location.href='/classificationEdit/${category.cid}'">
								</td>
							</tr>
						</c:forEach>
					</table>
